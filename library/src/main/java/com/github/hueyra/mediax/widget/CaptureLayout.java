...
public class CaptureLayout extends FrameLayout {
    ...
    private String getCaptureTip() {
        ...
        switch (buttonFeatures) {
            case Config.BUTTON_STATE_ONLY_CAPTURE:
                return getContext().getString(R.string.wx_camera_only_capture);
            case Config.BUTTON_STATE_ONLY_RECORDER:
                return getContext().getString(R.string.wx_camera_only_recorder);
            default:
                return getContext().getString(R.string.wx_camera_both);
        }
    }
    ...
    public void setCaptureBothAll() {
        setButtonFeatures(Config.BUTTON_STATE_BOTH);
    }

    public void setCaptureOnlyCapture() {
        setButtonFeatures(Config.BUTTON_STATE_ONLY_CAPTURE);
    }

    public void setCaptureOnlyRecorder() {
        setButtonFeatures(Config.BUTTON_STATE_ONLY_RECORDER);
    }
