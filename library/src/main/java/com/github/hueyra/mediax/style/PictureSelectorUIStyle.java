package com.github.hueyra.mediax.style;
...
public class PictureSelectorUIStyle {
    ...
    public static PictureSelectorUIStyle ofDefaultStyle() {
        ...
        uiStyle.picture_top_leftBack = R.mipmap.picture_icon_close;
        ...
        uiStyle.picture_top_titleArrowUpDrawable = R.mipmap.picture_icon_arrow_up;
        uiStyle.picture_top_titleArrowDownDrawable = R.mipmap.picture_icon_arrow_down;
        ...
        uiStyle.picture_adapter_item_camera_textTopDrawable = R.mipmap.picture_icon_camera;

        uiStyle.picture_adapter_item_textSize = 12;
        uiStyle.picture_adapter_item_textColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_adapter_item_video_textLeftDrawable = R.mipmap.picture_icon_video;
        uiStyle.picture_adapter_item_audio_textLeftDrawable = R.mipmap.picture_icon_audio;
        ...
        IMediaXApp app = MediaXAppInitializer.getInstance().getApp();
    ...
    public static PictureSelectorUIStyle ofSelectTotalStyle() {
        ...
        uiStyle.picture_top_leftBack = R.mipmap.picture_icon_back_arrow;
        uiStyle.picture_top_titleRightTextColor = new int[]{Color.parseColor("#000000"), Color.parseColor("#000000")};
        uiStyle.picture_top_titleRightTextSize = 14;
        uiStyle.picture_top_titleTextSize = 18;
        uiStyle.picture_top_titleArrowUpDrawable = R.mipmap.picture_icon_orange_arrow_up;
        uiStyle.picture_top_titleArrowDownDrawable = R.mipmap.picture_icon_orange_arrow_down;
    ...
    public static PictureSelectorUIStyle ofNewStyle() {
        ...
        uiStyle.picture_statusBarBackgroundColor = Color.parseColor("#3A3A3A");

        uiStyle.picture_container_backgroundColor = Color.parseColor("#3A3A3A");

        uiStyle.picture_switchSelectNumberStyle = true;

        uiStyle.picture_navBarColor = Color.parseColor("#3A3A3A");
        ...
        uiStyle.picture_top_titleRightTextSize = 14;
        uiStyle.picture_top_titleTextSize = 18;
        uiStyle.picture_top_titleArrowUpDrawable = R.mipmap.picture_icon_wechat_up;
        uiStyle.picture_top_titleArrowDownDrawable = R.mipmap.picture_icon_wechat_down;
        uiStyle.picture_top_titleTextColor = Color.parseColor("#FFFFFF");
        uiStyle.picture_top_titleBarBackgroundColor = Color.parseColor("#3A3A3A");
        ...
        uiStyle.picture_bottom_completeTextColor = new int[]{Color.parseColor("#9b9b9b"), Color.parseColor("#FA632D")};
        uiStyle.picture_bottom_barBackgroundColor = Color.parseColor("#3A3A3A");
