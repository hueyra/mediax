...
public final class PictureSelectionConfig implements Parcelable {
    ...
    public int buttonFeatures = Config.BUTTON_STATE_BOTH;
    ...
    public int minimumCompressSize = Config.MAX_COMPRESS_SIZE;
    public int imageSpanCount = Config.DEFAULT_SPAN_COUNT;
    ...
    public int pageSize = Config.MAX_PAGE_SIZE;
    ...
    protected void initDefaultValue() {
        ...
        compressQuality = 80;
        imageSpanCount = Config.DEFAULT_SPAN_COUNT;
        isCompress = false;
