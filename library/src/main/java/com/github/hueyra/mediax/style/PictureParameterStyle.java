...
public class PictureParameterStyle {
    ...
    public static PictureParameterStyle ofDefaultStyle() {
        ...
        // 相册列表标题栏右侧上拉箭头
        uiStyle.pictureTitleUpResId = R.mipmap.picture_icon_arrow_up;
        // 相册列表标题栏右侧下拉箭头
        uiStyle.pictureTitleDownResId = R.mipmap.picture_icon_arrow_down;
        // 相册文件夹列表选中圆点
        uiStyle.pictureFolderCheckedDotStyle = R.drawable.picture_orange_oval;
        // 相册返回箭头
        uiStyle.pictureLeftBackIcon = R.mipmap.picture_icon_back;
        // 标题栏字体颜色
        ...
        // 外部预览界面删除按钮样式
        uiStyle.pictureExternalPreviewDeleteStyle = R.mipmap.picture_icon_delete;
    ...
    public static PictureParameterStyle ofSelectTotalStyle() {
        ...
        // 相册列表标题栏右侧上拉箭头
        uiStyle.pictureTitleUpResId = R.mipmap.picture_icon_orange_arrow_up;
        // 相册列表标题栏右侧下拉箭头
        uiStyle.pictureTitleDownResId = R.mipmap.picture_icon_orange_arrow_down;
        // 相册文件夹列表选中圆点
        uiStyle.pictureFolderCheckedDotStyle = R.drawable.picture_orange_oval;
        // 相册返回箭头
        uiStyle.pictureLeftBackIcon = R.mipmap.picture_icon_back_arrow;
        // 标题栏字体颜色
    ...
    public static PictureParameterStyle ofNewStyle() {
        ...
        // 相册列表标题栏右侧上拉箭头
        uiStyle.pictureTitleUpResId = R.mipmap.picture_icon_wechat_up;
        // 相册列表标题栏右侧下拉箭头
        uiStyle.pictureTitleDownResId = R.mipmap.picture_icon_wechat_down;
        // 相册文件夹列表选中圆点
        uiStyle.pictureFolderCheckedDotStyle = R.drawable.picture_orange_oval;
        // 相册返回箭头
        uiStyle.pictureLeftBackIcon = R.mipmap.picture_icon_close;
        // 标题栏字体颜色
        uiStyle.pictureTitleTextColor = Color.parseColor("#FFFFFF");
        ...
        uiStyle.pictureWeChatLeftBackStyle = R.mipmap.picture_icon_back;
        // 相册列表底部背景色
        uiStyle.pictureBottomBgColor = Color.parseColor("#393a3e");
        // 已选数量圆点背景样式
        uiStyle.pictureCheckNumBgStyle = R.drawable.picture_num_oval;
