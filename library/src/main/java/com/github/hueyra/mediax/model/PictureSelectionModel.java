...
import com.github.hueyra.mediax.config.UCropOptions;
import com.github.hueyra.mediax.engine.CacheResourcesEngine;
import com.github.hueyra.mediax.engine.ImageEngine;
import com.github.hueyra.mediax.entity.LocalMedia;
import com.github.hueyra.mediax.listener.OnCustomCameraInterfaceListener;
import com.github.hueyra.mediax.listener.OnCustomImagePreviewCallback;
import com.github.hueyra.mediax.listener.OnResultCallbackListener;
import com.github.hueyra.mediax.listener.OnVideoSelectedPlayCallback;
import com.github.hueyra.mediax.style.PictureCropParameterStyle;
...
public class PictureSelectionModel {
    ...
    /**
     * @param selectionMode PictureSelector Selection model and Config.MULTIPLE or Config.SINGLE
     */
     ...
     * {link 如果是自定义相机则必须使用.startActivityForResult(this,Config.REQUEST_CAMERA);方式启动否则PictureSelector处理不了相机后的回调}
     *
     * @param listener Use ${bindCustomCameraInterfaceListener}
     */
    @Deprecated
    ...
    public PictureSelectionModel isWithVideoImage(boolean isWithVideoImage) {
        selectionConfig.isWithVideoImage =
                selectionConfig.selectionMode != Config.SINGLE
    ...
    public PictureSelectionModel isSingleDirectReturn(boolean isSingleDirectReturn) {
        selectionConfig.isSingleDirectReturn = selectionConfig.selectionMode
                == Config.SINGLE && isSingleDirectReturn;
        selectionConfig.isOriginalControl = (selectionConfig.selectionMode != Config.SINGLE || !isSingleDirectReturn) && selectionConfig.isOriginalControl;
        return this;
    }
    ...
    public PictureSelectionModel isPageStrategy(boolean isPageStrategy, int pageSize) {
        ...
        selectionConfig.pageSize = pageSize < Config.MIN_PAGE_SIZE ? Config.MAX_PAGE_SIZE : pageSize;
        return this;
    }
     ...
     *               2.2.9开始 Glide改为外部用户自己定义此方法没有意义了
     */
    @Deprecated
     ...
     *                       2.2.9开始Glide改为外部用户自己定义此方法没有意义了
     */
    @Deprecated
     ...
     *                       Use {link .selectionData()}
     */
    @Deprecated
    public PictureSelectionModel selectionMedia(List<LocalMedia> selectionMedia) {
        if (selectionConfig.selectionMode == Config.SINGLE && selectionConfig.isSingleDirectReturn) {
     ...
     * #适合所有style使用
     *
     * @param isOpenStyleNumComplete 使用setPictureStyle方法
     */
    @Deprecated
     ...
     * #适合qq style 样式使用
     *
     * @param isOpenStyleCheckNumMode 使用setPictureStyle方法
     */
    @Deprecated
     ...
     * 设置标题栏背景色
     *
     * @param color 使用setPictureStyle方法
     */
    @Deprecated
     ...
     * 裁剪页面标题背景色
     *
     * @param color 使用setPictureCropStyle方法
     */
    @Deprecated
     ...
     * 设置相册标题右侧向上箭头图标
     *
     * @param resId 使用setPictureStyle方法
     */
    @Deprecated
    ...
    public void forResult(int requestCode) {
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            activity.overridePendingTransition(windowAnimationStyle.activityEnterAnimation, R.anim.mx_anim_fade_in);
        }
    }
    ...
    public void forResult(OnResultCallbackListener listener) {
        if (!DoubleUtils.isFastDoubleClick()) {
            ...
            activity.overridePendingTransition(
                    windowAnimationStyle.activityEnterAnimation, R.anim.mx_anim_fade_in);
        }
    }
