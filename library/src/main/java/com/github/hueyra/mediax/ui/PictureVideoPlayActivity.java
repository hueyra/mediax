...
public class PictureVideoPlayActivity extends PictureBaseActivity implements
    ...
    protected void initWidgets() {
        super.initWidgets();
        videoPath = getIntent().getStringExtra(Config.EXTRA_VIDEO_PATH);
        boolean isExternalPreview = getIntent().getBooleanExtra
                (Config.EXTRA_PREVIEW_VIDEO, false);
        if (TextUtils.isEmpty(videoPath)) {
            LocalMedia media = getIntent().getParcelableExtra(Config.EXTRA_MEDIA_KEY);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.pictureLeftBack) {
            ...
            result.add(getIntent().getParcelableExtra(Config.EXTRA_MEDIA_KEY));
            setResult(RESULT_OK, new Intent()
                    .putParcelableArrayListExtra(Config.EXTRA_SELECT_LIST,
