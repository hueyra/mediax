...
import com.github.hueyra.mediax.broadcast.BroadcastAction;
import com.github.hueyra.mediax.broadcast.BroadcastManager;
...
import com.github.hueyra.mediax.listener.OnImageCompleteCallback;
...
import com.github.hueyra.mediax.widget.longimage.ImageSource;
import com.github.hueyra.mediax.widget.longimage.ImageViewState;
...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    protected void initWidgets() {
        ...
        if (getIntent().getSerializableExtra(Config.EXTRA_PREVIEW_SELECT_LIST) != null) {
            images = (List<LocalMedia>) getIntent().getSerializableExtra(Config.EXTRA_PREVIEW_SELECT_LIST);
        }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.left_back) {
            ...
            if (images != null && images.size() > 0) {
                ...
                bundle.putInt(Config.EXTRA_PREVIEW_DELETE_POSITION, currentItem);
            ...
            if (media != null) {
                        ...
                        if (config.isNotPreviewDownload) {
                            if (PermissionChecker.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                                ...
                                PermissionChecker.requestPermissions(PictureExternalPreviewActivity.this,
                                        new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, Config.APPLY_STORAGE_PERMISSIONS_CODE);
                            }
                        }
                        return true;
                    });
                ...
                ivPlay.setOnClickListener(v -> {
                    if (PictureSelectionConfig.customVideoPlayCallback != null) {
                        ...
                        Bundle bundle = new Bundle();
                        bundle.putString(Config.EXTRA_VIDEO_PATH, path);
                        intent.putExtras(bundle);
                        JumpUtils.startPictureVideoPlayActivity(container.getContext(), bundle, Config.PREVIEW_VIDEO_CODE);
                    }
                });
            }
    ...
    private void exitAnimation() {
        overridePendingTransition(R.anim.mx_anim_fade_in, PictureSelectionConfig.windowAnimationStyle.activityPreviewExitAnimation);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == Config.APPLY_STORAGE_PERMISSIONS_CODE) {// 存储权限
