...
import com.github.hueyra.mediax.tools.AnimUtils;
...
public class PictureImageGridAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        if (showCamera && position == 0) {
            return Config.TYPE_CAMERA;
        } else {
            return Config.TYPE_PICTURE;
        }
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == Config.TYPE_CAMERA) {
    ...
    public void onBindViewHolder(@NotNull final RecyclerView.ViewHolder holder, final int position) {
        if (getItemViewType(position) == Config.TYPE_CAMERA) {
                ...
                if (PictureSelectionConfig.uiStyle != null) {
                    if (isHasVideo) {
                        if (PictureSelectionConfig.uiStyle.picture_adapter_item_video_textLeftDrawable != 0) {
                            ...
                            contentHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                                    (R.mipmap.picture_icon_video, 0, 0, 0);
                        }
                    } else {
                        if (PictureSelectionConfig.uiStyle.picture_adapter_item_audio_textLeftDrawable != 0) {
                            ...
                            contentHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                                    (R.mipmap.picture_icon_audio, 0, 0, 0);
                        }
                    }
                } else {
                    contentHolder.tvDuration.setCompoundDrawablesRelativeWithIntrinsicBounds
                            (isHasVideo ? R.mipmap.picture_icon_video : R.mipmap.picture_icon_audio,
                                    0, 0, 0);
                }
            } else {
            ...
            contentHolder.contentView.setOnClickListener(v -> {
                ...
                boolean eqResult =
                        PictureMimeType.isHasImage(mimeType) && config.enablePreview
                                ...
                                || config.selectionMode == Config.SINGLE)
    ...
    private void changeCheckboxState(ViewHolder contentHolder, LocalMedia image) {
        ...
        if (isChecked) {
            ...
            contentHolder.tvCheck.startAnimation(AnimationUtils.loadAnimation(context, R.anim.mx_anim_modal_in));
        }
